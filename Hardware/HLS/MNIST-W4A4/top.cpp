...
#pragma HLS STREAM variable=inter3 depth=16
  ...
  const unsigned int outBits = L3_OFM_DIM * L3_OFM_DIM * L3_OFM_CH * 8;
  ...
  >
  (inter3, memOutStream, weights3, TanhActivation<ap_fixed<32,16>, ap_int<8>>(), numReps, ap_resource_lut());
